...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1494961135ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wbd_project&table=orders_t">`wbd_project`.`orders_t`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wbd_project&table=buyer">`wbd_project`.`buyer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wbd_project&table=products">`wbd_project`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wbd_project&table=farmer">`wbd_project`.`farmer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wbd_project&table=addd">`wbd_project`.`addd`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6a527940335f33666a6440305a364867">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="wbd_project" targettable="products">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `products`(`productname`, `image`, `Inventory`, `category`, `Price`) VALUES (&#039;apple&#039;,&#039;../images/apple.jpg&#039;,&#039;50&#039;,&#039;1&#039;,&#039;2&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="wbd_project" targettable="products">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `products`(`productname`, `image`, `Inventory`, `category`, `Price`) VALUES (&#039;carrot&#039;,&#039;../images/carrot.jpg&#039;,&#039;45&#039;,&#039;0&#039;,&#039;1&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="wbd_project" targettable="products">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `products`(`productname`, `image`, `Inventory`, `category`, `Price`) VALUES (&#039;onion&#039;,&#039;../images/onion.jpg&#039;,&#039;15&#039;,&#039;0&#039;,&#039;1&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="wbd_project" targettable="products">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `products`(`productname`, `image`, `Inventory`, `category`, `Price`) VALUES (&#039;tomato&#039;,&#039;../images/tomato.jpg&#039;,&#039;30&#039;,&#039;0&#039;,&#039;3&#039;);</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="wbd_project" targettable="farmer">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `farmer`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="wbd_project" targettable="buyer">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `buyer`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="wbd_project" targettable="products">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `products`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="wbd_project" targettable="orders_t">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `wbd_project`.`orders_t` ( `p_id` INT UNSIGNED NOT NULL ,  `b_id` INT UNSIGNED NOT NULL ,  `productname` VARCHAR(20) NOT NULL ,  `price` INT(20) NOT NULL ,  `image` VARCHAR(255) NOT NULL ,  `order_id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,    PRIMARY KEY  (`order_id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="wbd_project" targettable="orders_t">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `orders_t`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="wbd_project" targettable="orders_t">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `orders_t` DROP `p_id`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="wbd_project" targettable="buyer">
                            <div class="action_content">
