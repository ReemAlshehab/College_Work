  ...
  ?>
        <div class="header"> 
            ...
            <div class="profile text-center">
                ...
                <img src="../images/website_farmer_icon.png" width="100px">
                <form method="POST" class="profile-form text-center">
                    ...
                    <input type="text" name="sname" class="textb" id="storename" value="<?php echo $row['StoreName'];?>" readonly><br>
                    ...
                    <input type="text" name="id" class="textb" id="b_id" value="<?php echo $row['f_id'];?>" readonly><br>
