...
// step 3# create an insert sql query 
            $sql = "SELECT * FROM farmer WHERE StoreName = '$sname' and Password = '$f_pass'" or die("Failed to query database" . mysqli_errno());
            ...
            <div class="container">
                ...
                <div class="profile text-center">
                    ...
                    <form method="POST" class="profile-form text-center">
                        ...
                        <input type="text" name="sname" class="textb" id="store" required><br>                      
