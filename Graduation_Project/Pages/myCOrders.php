...
<html>
    ...
    <body>
        ...
        <main>
          ...
          <?php
            $result = $con->query("select * from completedoccasion where Customer_ID=".$_SESSION["id"]);
            if ($result->num_rows > 0)
            {
            echo '<h4 style="text-align: center;">Your Completed Orders</h4>';
            echo "<table class='tb' align='center'>
              ...
              echo '<h4 style="text-align: center;">Theres no Completed Occasion</h4>';
            }
        ?>
        </main>
