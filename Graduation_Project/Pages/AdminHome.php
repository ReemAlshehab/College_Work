              ...
              <tr>
                <td>
                  <div style="background-color:#DCDCDC;">
                    <img src="../images/orders.png" alt="Orders" width="300px" height="300px"><br>
                    <a href="allOrders.php"><b>Requested Occasions</b></a><br>
                    <!-- <span>my previ</span> -->
                  </div>
                </td>
                <td>
                  <div style="background-color:#DCDCDC;">
                    <img src="../images/payment.png" alt="payment" width="300px" height="300px"><br>
                ...
                <td>
                  <div style="background-color:#DCDCDC;">
                    <img src="../images/Complete.png" alt="complete" width="300px" height="300px"><br>
                    <a href="allCOrders.php"><b>Completed Occasions</b><br></a>
                  </div>
                </td>
                <td>
                  <div style="background-color:#DCDCDC;">
                    <img src="../images/Complete.png" alt="Users" width="300px" height="300px"><br>
                    <a href="Users.php"><b>Users</b><br></a>
                  </div>
                </td>
              </tr>
